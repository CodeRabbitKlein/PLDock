...
def parse_train_args():
    ...
    parser.add_argument('--pdbbind_dir', type=str, default='data/pdbbind/', help='Folder containing original structures')
    parser.add_argument('--dataset', type=str, default='pdbbind', help='Folder containing original structures')
    parser.add_argument('--split_train', type=str, default='data/splits/train.txt', help='Path of file defining the split')
    parser.add_argument('--split_val', type=str, default='data/splits/val.txt', help='Path of file defining the split')
    parser.add_argument('--split_test', type=str, default='data/splits/test.txt', help='Path of file defining the split')
    ...
    parser.add_argument('--project', type=str, default='dock', help='')
    ...
    parser.add_argument('--num_dataloader_workers', type=int, default=4, help='Number of workers for dataloader')
    ...
    # Dataset 
    parser.add_argument('--limit_complexes', type=int, default=None, help='If positive, the number of training and validation complexes is capped') # TODO change
    ...
    #1->5
    parser.add_argument('--num_conformers', type=int, default=5, help='Number of conformers to match to each ligand')
    ...
    parser.add_argument('--pdbbind_esm_embeddings_path', type=str, default='data/pdb.pt', help='If this is set then the LM embeddings at that path will be used for the receptor features')
